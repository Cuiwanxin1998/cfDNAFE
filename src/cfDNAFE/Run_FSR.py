    ...
    def __init__(
        ...
        **kwargs
        ...
        {P}arameters:
            ...
            continue_N:int continue window number.
        ...
        for x in self.getInput("bedgzInput"):
            outputfile = os.path.join(self.getOutput("outputdir"), self.getMaxFileNamePrefixV2(x)) + ".FSR"
        ...
        if verbose:
            ...
            self.multiRun(
                args=args, func=calc_FSR, nCore=maxCore(self.getParam("threads")),
            )
