...
class readCounter(Base):
    def __init__(
        ...
        """
                ...
                {P}arameters:
                    pathToreadCounter: str, /path/to/HMMcopy/bin/readCounter.
        ...
        if pathToreadCounter is None:
            raise commonError("Parameter pathToreadCounter must require. /path/to/HMMcopy/bin/readCounter")
        if bamInput is None:
