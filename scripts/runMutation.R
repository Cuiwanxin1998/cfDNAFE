...
option_list <- list(
  ...
  make_option(c("--outputfile1"), type='character', default='test.96.mutation.profile', help='96 mutational profile. Default: [%default]'),
  make_option(c("--outputfile2"), type='character', default='test.signatures', help='Fit mutation matrix to the COSMIC mutational signatures. Default: [%default]')
  )
